...
const ProfileDrawer: React.FC<ProfileDrawerProps> = ({
    ...
    return (
        <>
            <ConfirmModal onClose={() => setIsModalOpen(false)} isOpen={isModalOpen} />
                    ...
                    <div className='fixed inset-0 overflow-hidden'>
                        <div className='absolute inset-0 overflow-hidden'>
                            ...
                            ' enterFrom='"translate-x-full' enterTo='"translate-x-0'
                                    leaveFrom='transform transition ease-in-out duration-500'
                                            ...
                                            <div className='relative mt-6 flex-1 px-4 sm:px-6'>
                                                <div className='flex flex-col items-center'>
                                                    ...
                                                    <div className='flex gap-10 my-8'>
                                                        <div onClick={() => setIsModalOpen(true)} className='flex flex-col gap-3 items-center cursor-pointer
                                                    hover:opacity-75
                                                    '>
